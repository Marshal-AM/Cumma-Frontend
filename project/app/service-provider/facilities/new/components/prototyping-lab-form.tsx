...
const prototypingLabSchema = z.object({
...
type FormData = z.infer<typeof prototypingLabSchema>;

export default function PrototypingLabForm() {
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [images, setImages] = useState<string[]>([]);

  const { register, control, handleSubmit, formState: { errors } } = useForm<FormData>({
    resolver: zodResolver(prototypingLabSchema),
    defaultValues: {
